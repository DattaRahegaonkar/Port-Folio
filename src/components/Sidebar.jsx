...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`relative w-[18px] h-[2px] bg-gray-700 transition-all duration-300 ${
            open ? "bg-transparent" : ""
          }`}
        >
          <span
      ...
      >
        <div className="absolute top-0 left-0 w-full h-full p-[30px] overflow-y-auto flex flex-col justify-between">
          <div>
            {/* Logo */}
